		            	...
		            	<div class="pad-btm form-inline">
				            <div class="row">
				                <div class="col-sm-6 table-toolbar-left">
				                   <a href="{{ route('categories.create') }}" id="demo-btn-addrow" class="btn btn-purple"><i class="demo-pli-add"></i> Thêm mới người dùng</a>
				                </div>
		                    ...
		                    <table class="table table-bordered table-hover table-vcenter">
		                        ...
		                        <tbody>
		                            <tr ng-repeat="(key, language) in data.languages">
		                                ...
		                                <td>
		                                	<span ng-if="(language.status == '{{ App\Libs\Configs\StatusConfig::CONST_DISABLE }}')"> Không hoạt động</span>

		                                	<span ng-if="(language.status == '{{ App\Libs\Configs\StatusConfig::CONST_AVAILABLE }}')"> Hoạt động</span>
		                                </td>
